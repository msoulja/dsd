...
questions_list = [
    Question('В каком году был основан Екатеринбург?','1723','1233','1999','1541'),
    Question('к4еш4кшпклп?','24242','1111','2123332','214453443'),
    Question('оашуу5вегы4?','1111','22222','3333333','444444')
]
...
def next_question():
    ...
    window.cur_question = randint(0,len(questions_list) - 1)# переходим к следующему вопросу
...
def check_answer():
    if answers[0].isChecked():
        flag.setText('Правильно!')
        window.score += 1
    else:
        flag.setText('Неверно!')
    ans_true.setText(answers[0].text())
...
flag = QLabel('Правильно/Неправильно')
ans_layout = QVBoxLayout()
ans_layout.addWidget(flag,alignment =(Qt.AlignLeft | Qt.AlignTop))
ans_layout.addWidget(ans_true, alignment = (Qt.AlignCenter) )
